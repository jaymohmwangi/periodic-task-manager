    ...
    <div class="">
        ...
        <div class="col-span-6 sm:col-span-4 pt-2">
            <div class="flex justify-between items-center">
                <x-jet-label for="task_group_id" value="{{ __('Task Group') }}"/>
                <a href="#" onclick="openCreateTaskGroupModal()"
                   class="text-sm text-gray-500 underline text-indigo-700">Add New Task Group</a>
            </div>
